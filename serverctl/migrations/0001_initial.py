# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-03-25 13:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('LOADING', '起動中'), ('RUNNING', '作動中'), ('SAVING', '保存中'), ('STOPPING', '停止中')], default='STOPPING', max_length=6)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('server', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='serverctl.GameServer')),
            ],
        ),
        migrations.CreateModel(
            name='Player',
